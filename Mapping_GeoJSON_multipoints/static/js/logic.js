...
// Create the map object with a center and zoom level, for Los Angeles
// let map = L.map('mapid').setView([40.7, -94.5], 4);

// Add GeoJSON data. Coordinates are backwards because x = long and y = lat per geojson standard
let sanFranAirport =
